          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            {template.images.length > 1 && (
              <div className="p-6 bg-white flex-shrink-0">
                <div className="flex items-center justify-center gap-2 overflow-x-auto overflow-y-hidden scrollbar-hide w-fit h-fit mx-auto">
                    ...
                    <button
                      ...
                      className={`relative overflow-hidden rounded-lg transition-all flex-shrink-0 ${
                        selectedImageIndex === index 
                          ? 'ring-2 ring-[#FF7B00] ring-offset-1 scale-105' 
